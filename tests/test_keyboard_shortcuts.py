...
def test_keyboard_shortcuts_documented():
    ...
    assert 'Keyboard Shortcuts' in content, "Keyboard shortcuts section not found in README"
    assert '⌨️' in content or 'keyboard' in content.lower(), "Keyboard emoji or mention not found"
    ...
    for shortcut in shortcuts:
        ...
        if shortcut == 'Escape':
            ...
            assert re.search(pattern, content, re.IGNORECASE), f"Shortcut key '{shortcut}' not documented"
